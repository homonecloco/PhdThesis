...
\item[F$_{2}$] A single heterozygous $F_{1}$ plant is crossed to itself (self-crossed) and the progeny is segregating. This type of population is used for the experiments in Chapter \ref{yr15} and it is described in more detail in Section \ref{yr15:f2}. 
\item[Back cross (BC)]

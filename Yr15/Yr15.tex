...
From the five homoeologous SNPs, three of them were monomorphic and two polymorphic, suggesting that PolyM{}arker is effective on detecting which assays are less likely to work (Table \ref{tab:yr15:markersToTest}; Figure \ref{fig:yr15:r2},\subref{fig:yr15:r8}).
...
%From the 35 SNPs tested, 28 were polymorphic across the parents (80%), with three diagnostic for Yr15 in the panel (R5, R8 and R33, Figure 6b). We also identified five SNPs as homoeolo- gous, three of which were monomorphic across the parents and two polymorphic SNPs that were not diagnostic across the panel. To determine the genetic position of these SNPs relative to Yr15, we developed a genetic map using the phenotyped F2 individuals (Figure 1b,e).
